        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    <Link href="/" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Home</Link>
                    <Link href="/about-us" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">About Us</Link>
                    <Link href="/contact-us" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Contact Us</Link>
                </div>
            </div>
{/*
            <div>
...
*/}
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    <Link href="/artisan-discovery" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Artisans Discovery</Link>
            ...
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    <Link href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">(020) 456-7890</Link>
                    <Link href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">contact@craftyhands.vercel.app</Link>
                </div>
            </div>
        </div>
