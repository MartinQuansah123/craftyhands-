            ...
            try {
              ...
              if (userDocSnapshot.exists()) {
               ...
               // Check user type and redirect accordingly
                if (!userData.accountType === "Super Admin"  && userData.accountType === "Mini Admin") {
                    // User is not a creator or donor but is a mini admin, redirect to /dashboard
                    router.push(`/dashboard/${id}/dashboard`);
                } // Check user type and redirect accordingly
               else if (!userData.accountType === "Super Admin"  && userData.accountType === "Artisan") {
                    // User is not a creator or donor but is a mini admin, redirect to /dashboard
                    router.push(`/account/${id}/dashboard`);
                } else if (!userData.accountType === "Super Admin" && userData.accountType === "Client") {
...
{/*
        ...
        */}
            <div onClick={() => router.push(`/my-admin/${id}/bookings/manage`)} class="cursor-pointer flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
                </svg>

                <span class="mx-2 text-sm font-medium">Booking Management</span>
            </div>
{/*
